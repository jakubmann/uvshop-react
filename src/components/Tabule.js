...
const Tabule = (props) => {
  ...
  const [variant, setVariant] = useState(variants.find((v) => v.available)?.id)
  ...
  return (
    <div className="tabule">
      <div className="tabule__content">
        ...
        />
        <VariantSelector handleVariant={handleVariant} variants={variants} />
        <input
        ...
        <button onClick={() => props.addToCart(variant, quantity)}>
          Add To Cart
        </button>
